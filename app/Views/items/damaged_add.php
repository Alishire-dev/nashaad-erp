<h2>Add Damaged Products</h2>

<form method="post" action="<?= site_url('damaged-products/add') ?>" id="damagedForm">
    <?= csrf_field() ?>
    ...
    <button type="button" class="btn" style="background:#c0392b; margin-bottom:16px;" onclick="addRow()">+ Add Row</button>
    ...
    <a class="btn" href="<?= site_url('damaged-products') ?>">Cancel</a>
</form>
