...
<a class="btn" style="background:#3a8fd6;" href="<?= site_url('issued-products/add') ?>">+ Add Issued</a>
<br><br>
            ...
            <td>
                <div class="action-dropdown">
                    ...
                    <div class="action-dropdown-menu">
                        <form method="post" action="<?= site_url('issued-products/delete/' . $row['id']) ?>"
...
$(document).ready(function () { initDataTable('#issuedTable', { columnDefs: [{ orderable: false, targets: [8] }] }); });
</script>
