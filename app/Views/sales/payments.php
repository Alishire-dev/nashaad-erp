...
<div class="payments-card">
    ...
    <div class="payments-body">
        ...
        <form method="post" action="<?= site_url('sales/payments/' . $sale['id'] . '/add') ?>" style="display:flex; gap:10px; align-items:flex-end; flex-wrap:wrap;">
            <?= csrf_field() ?>
        ...
        <div style="text-align:right; margin-top:20px;">
            <a class="btn" href="<?= site_url('sales/list') ?>">Close</a>
        </div>
    </div>
</div>
